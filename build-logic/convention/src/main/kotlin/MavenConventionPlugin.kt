...
import com.mmoczkowski.kotlink.publicationId
            ...
            project.extensions.configure<PublishingExtension> {
                publications {
                    create(project.publicationId, MavenPublication::class.java) {
                        ...
                        artifactId = "kotlink-${project.path.substring(1).replace(":", "-")}"
                        version = System.getenv("VERSION")
                        description = "Kotlin MAVLink library"

                        pom {
                            name.set("KOTLink")
                            description.set("Kotlin MAVLink library")
                            url.set("http://github.com/mmoczkowski/kotlink")
                            licenses {
                                license {
